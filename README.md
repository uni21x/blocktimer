...
- **🌍 Internationalization**: Switch between German (DE) and English (EN).
- **🔒 Sequential Logic**: Recurring blocks (e.g., "Deep Work 1/3") are locked sequentially. You can only start the next block when the previous one is done.
- **🛡️ 24h Limits**: Built-in validation ensures your daily plan and single blocks never exceed 24 hours.
- **📊 Smart Sorting**: Finished tasks move to the bottom, active tasks bubble to the top.
